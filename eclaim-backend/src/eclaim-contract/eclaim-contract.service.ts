  ...
  async prepareFhirSubmit(raw: unknown) {
    ...
    return {
      claimStruct: {
        ...
        patientNameHash: claimStruct.patientNameHash,
        accessCodeHash: claimStruct.accessCodeHash,
        bundleIdHash: claimStruct.bundleIdHash,
        crIdHash: claimStruct.crIdHash,
        externalIdHash: claimStruct.externalIdHash,
        shaCodeHash: claimStruct.shaCodeHash,
        shaPackageCodeHash: claimStruct.shaPackageCodeHash,
        ...
        dateProcessed: claimStruct.dateProcessed.toString(),
        claimedTotal: claimStruct.claimedTotal.toString(),
        approvedTotal: claimStruct.approvedTotal.toString(),
        adjustment: claimStruct.adjustment.toString(),
        hasApprovedTotal: claimStruct.hasApprovedTotal,
        hasAdjustment: claimStruct.hasAdjustment,
        hasDateProcessed: claimStruct.hasDateProcessed,
        auditFlag: claimStruct.auditFlag,
        ipsClaim: claimStruct.ipsClaim,
        nationalIdHash: claimStruct.nationalIdHash,
        guaranteeIdHash: claimStruct.guaranteeIdHash,
        explanationHash: claimStruct.explanationHash,
        rejectionReasonHash: claimStruct.rejectionReasonHash,
        status: claimStruct.status,
        surveillanceStatus: claimStruct.surveillanceStatus,
        colourCodeHash: claimStruct.colourCodeHash,
        count: claimStruct.count.toString(),
      },
      claimId: parsed.claimId,
      recordUse: parsed.recordUse,
      fid: parsed.fid,
